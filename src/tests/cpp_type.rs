...
fn void() {
  ...
  assert_eq!(type1.base.caption(TypeCaptionStrategy::Short), "void");
...
fn int() {
  ...
  assert!(type1.to_cpp_code(Some(&String::new())).is_err());
  assert!(type1.base.to_cpp_code(Some(&String::new())).is_err());
  assert_eq!(type1.base.caption(TypeCaptionStrategy::Short), "int");
...
fn bool_ptr() {
  ...
  assert!(type1.to_cpp_code(Some(&String::new())).is_err());
  assert!(type1.base.to_cpp_code(Some(&String::new())).is_err());
  assert_eq!(type1.base.caption(TypeCaptionStrategy::Short), "bool");
...
fn char_ptr_ptr() {
  ...
  assert!(type1.to_cpp_code(Some(&String::new())).is_err());
  assert!(type1.base.to_cpp_code(Some(&String::new())).is_err());
  assert_eq!(type1.base.caption(TypeCaptionStrategy::Short), "char");
...
fn qint64() {
  ...
  assert!(type1.to_cpp_code(Some(&String::new())).is_err());
  assert!(type1.base.to_cpp_code(Some(&String::new())).is_err());
  assert_eq!(type1.base.caption(TypeCaptionStrategy::Short), "qint64");
...
fn quintptr() {
  ...
  assert!(type1.to_cpp_code(Some(&String::new())).is_err());
  assert!(type1.base.to_cpp_code(Some(&String::new())).is_err());
  assert_eq!(type1.base.caption(TypeCaptionStrategy::Short), "quintptr");
...
fn enum1() {
  ...
  assert!(type1.to_cpp_code(Some(&String::new())).is_err());
  assert!(type1.base.to_cpp_code(Some(&String::new())).is_err());
  assert_eq!(type1.base.caption(TypeCaptionStrategy::Short),
             "Qt_CaseSensitivity");
...
fn class_value() {
  ...
  assert!(type1.to_cpp_code(Some(&String::new())).is_err());
  assert!(type1.base.to_cpp_code(Some(&String::new())).is_err());
  assert_eq!(type1.base.caption(TypeCaptionStrategy::Short), "QPoint");
...
fn class_const_ref() {
  ...
  assert!(type1.to_cpp_code(Some(&String::new())).is_err());
  assert!(type1.base.to_cpp_code(Some(&String::new())).is_err());
  assert_eq!(type1.base.caption(TypeCaptionStrategy::Short), "QRectF");
...
fn class_mut_ptr() {
  ...
  assert!(type1.to_cpp_code(Some(&String::new())).is_err());
  assert!(type1.base.to_cpp_code(Some(&String::new())).is_err());
  assert_eq!(type1.base.caption(TypeCaptionStrategy::Short), "QObject");
...
fn template_parameter2() {
  let type1 = create_template_parameter_type();
  type1.base.caption(TypeCaptionStrategy::Short);
}
...
fn function1() {
  ...
  assert!(type1.to_cpp_code(None).is_err());
  assert!(type1.base.to_cpp_code(None).is_err());
  assert_eq!(type1.base.caption(TypeCaptionStrategy::Short), "func");
  assert_eq!(type1.base.caption(TypeCaptionStrategy::Full),
