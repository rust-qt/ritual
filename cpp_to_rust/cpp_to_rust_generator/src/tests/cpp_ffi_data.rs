...
fn argument_int() {
    ...
    assert_eq!(
        arg.caption(ArgumentCaptionStrategy::TypeOnly(
    ...
    assert_eq!(
        arg.caption(ArgumentCaptionStrategy::TypeOnly(TypeCaptionStrategy::Full))
            .unwrap(),
        "int"
    );
    assert_eq!(
        arg.caption(ArgumentCaptionStrategy::TypeAndName(
            TypeCaptionStrategy::Short,
        ))
        .unwrap(),
        "int_arg1"
...
fn signature_two_numbers() {
    ...
    assert_eq!(
        sig.arguments_caption(ArgumentCaptionStrategy::NameOnly)
            .unwrap(),
        "arg1_arg2"
    );
    assert_eq!(
        sig.arguments_caption(ArgumentCaptionStrategy::TypeOnly(
            TypeCaptionStrategy::Short,
        ))
        .unwrap(),
        "int_double"
    ...
    assert_eq!(
        sig.arguments_caption(ArgumentCaptionStrategy::TypeOnly(TypeCaptionStrategy::Full))
            .unwrap(),
        "int_double"
    );
    assert_eq!(
        sig.arguments_caption(ArgumentCaptionStrategy::TypeAndName(
            TypeCaptionStrategy::Short,
        ))
        .unwrap(),
    ...
    assert_eq!(
        sig.caption(MethodCaptionStrategy::ArgumentsOnly(
...
fn signature_class_method_const() {
    ...
    assert_eq!(
        sig.caption(MethodCaptionStrategy::ConstAndArguments(
            ArgumentCaptionStrategy::NameOnly,
        ))
        .unwrap(),
        "const_arg1"
