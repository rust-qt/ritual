...
fn void() {
  ...
  assert_eq!(type1.base.caption(TypeCaptionStrategy::Short).unwrap(),
             "void");
...
fn void_ptr() {
  ...
  assert_eq!(type1.base.caption(TypeCaptionStrategy::Short).unwrap(),
             "void");
  assert_eq!(type1.caption(TypeCaptionStrategy::Short).unwrap(), "void");
  assert_eq!(type1.caption(TypeCaptionStrategy::Full).unwrap(),
             "void_ptr");
  assert_type_to_ffi_unchanged(&type1);
  assert!(!type1.needs_allocation_place_variants());
  assert_eq!(type1.base.maybe_name(), None);
...
fn quintptr() {
  ...
  assert_eq!(type1.base.caption(TypeCaptionStrategy::Short).unwrap(),
             "quintptr");
  assert_eq!(type1.caption(TypeCaptionStrategy::Short).unwrap(),
             "quintptr");
  assert_eq!(type1.caption(TypeCaptionStrategy::Full).unwrap(),
             "quintptr");
  assert_type_to_ffi_unchanged(&type1);
...
fn function1() {
  ...
  assert_eq!(type1.base.caption(TypeCaptionStrategy::Short).unwrap(),
             "func");
  assert_eq!(type1.base.caption(TypeCaptionStrategy::Full).unwrap(),
